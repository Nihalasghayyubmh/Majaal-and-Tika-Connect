...
# Action Name: NPS 24H After Delivery
# Model: stock.picking
# TRIGGER: Based on Timed Condition (date_done)
# EXECUTION FREQUENCY: 
# | Setting | Value |
# | ------- | ----- |
# | Execute | After |
...
# | Field        | Correct Value                         |
# | ------------ | ------------------------------------- |
# | Model        | Inventory Transfers (`stock.picking`) |
# | Trigger      | Based on Timed Condition              |
# | Trigger Date | Effective Date (`date_done`)          |
# | Delay        | 2 Minutes After                       |
# | Apply On     | `state = done`                        |
...
# =====================================================
# Majaal NPS WhatsApp Automation
# =====================================================

template_name = 'Majaal Feedback Message Template'
...
# PROCESS
# =====================================================
record.message_post(body="NPS AUTOMATION TRIGGERED")

if is_valid:
    record.message_post(body="is_valid is true")
    # =====================================================
    # PHONE SANITIZATION
    # =====================================================
