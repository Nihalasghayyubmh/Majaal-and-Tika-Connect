...
# Action Name: Invoice WhatsApp Automation
# Model: account.move
...
# =====================================================
# Majaal Invoice WhatsApp Automation
# =====================================================

template_name = 'majaal_invoice_message_template'
...
# Block credit notes (invoice returns)
...
if is_valid:
    ...
    if formatted_phone:
        ...
        try:
            ...
            record.message_post(
                body=f"INVOICE SCRIPT ERROR: {str(e)}"
            )
